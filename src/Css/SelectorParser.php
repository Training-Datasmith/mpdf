...
class SelectorParser
{
     ...
     */
    public function parsePageSelector(array $tags)
    {
        $level = count($tags);
        $t = '';
        $t2 = '';
     ...
     */
    public function parseSimpleSelector(array $tags)
    {
     ...
     */
    public function parseCascadedSelector(array $tags)
    {
        $tmp = [];
        $level = count($tags);
     ...
     */
    public function matchesNthChild(array $nthComponents, $index)
    {
        ++$index;
        $select = false;
