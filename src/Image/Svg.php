...
class Svg
{
    ...
    public function svgImage(array $attribs)
    {
    ...
    public function svgGradient(array $gradient_info, array $attribs, $element)
    {
    ...
    public function svgOffset(array $attribs)
    {
    ...
    public function svgDefineStyle(array $critere_style)
    {
    ...
    public function svgStyle(array $critere_style, $attribs, $element)
    {
        $path_style = '';
        $fill_gradient = '';
        $w = '';
    ...
    public function svgRect(array $arguments)
    {
     ...
     */
    public function svgEllipse(array $arguments)
    {
    ...
    public function svgDefineTxtStyle(array $critere_style)
    {
     ...
     */
    public function mergeStyles($data)
    {
        $xml = new \DOMDocument();
    ...
    private function computeBezierBoundingBox(array $start, array $c)
    {
        $P0 = [$start[0], $start[1]];
        $P1 = [$c[0], $c[1]];
        $P2 = [$c[2], $c[3]];
