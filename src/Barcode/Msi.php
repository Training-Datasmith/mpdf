 ...
 */
class Msi extends \Mpdf\Barcode\Abstract_Barcode implements \Mpdf\Barcode\Barcode_Interface
{
    /**
     * @param int $code
     * @param bool $checksum
     ...
     * @param bool $checksum
     */
    private function init(array $code, $checksum)
    {
        $chr = ['0' => '100100100100', '1' => '100100100110', '2' => '100100110100', '3' => '100100110110', '4' => '100110100100', '5' => '100110100110', '6' => '100110110100', '7' => '100110110110', '8' => '110100100100', '9' => '110100100110', 'A' => '110100110100', 'B' => '110100110110', 'C' => '110110100100', 'D' => '110110100110', 'E' => '110110110100', 'F' => '110110110110'];
        $checkdigit = '';
        if ($checksum) {
            // add checksum
            $clen = strlen($code);
        ...
        for ($i = 0; $i < $clen; ++$i) {
            ...
            if (!isset($chr[$digit])) {
                // invalid character
                throw new \Mpdf\Barcode\Barcode_Exception(sprintf('Invalid character "%s" in MSI barcode value "%s"', $digit, $code));
            }
            $seq .= $chr[$digit];
        }
        $seq .= '1001';
        ...
        $this->data = $this->binseq_to_array($seq, $bararray);
    }
    /**
     * @inheritdoc
     */
