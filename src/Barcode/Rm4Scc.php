...
class Rm4Scc extends \Mpdf\Barcode\Abstract_Barcode implements \Mpdf\Barcode\Barcode_Interface
{
    /**
     * @param string $code
     * @param float $xDim
     ...
     * @param bool $kix
     */
    public function __construct($code, $x_dim, $gap_width, $daft, $kix = false)
    {
        $this->init($code, $gap_width, $daft, $kix);
     ...
     * @param bool $kix
     */
    private function init($code, $gap_width, array $daft, $kix)
    {
        $notkix = !$kix;
        // bar mode
        // 1 = pos 1, length 2
        ...
        if ($notkix) {
            ...
            $bararray['bcode'][$k++] = ['t' => 0, 'w' => $gap_width, 'h' => $daft['A'], 'p' => 0];
