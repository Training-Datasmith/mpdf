 ...
 */
class Code39 extends \Mpdf\Barcode\Abstract_Barcode implements \Mpdf\Barcode\Barcode_Interface
{
    /**
     * @param string $code
     ...
     * @param bool $checksum
     */
    public function __construct($code, $print_ratio, $extended = false, $checksum = false, $quiet_zone_left = null, $quiet_zone_right = null)
    {
        $this->init($code, $print_ratio, $extended, $checksum);
     ...
     * @return mixed[]
     */
    private function init($code, $print_ratio, $extended, $checksum)
    {
        $chr = ['0' => '111221211', '1' => '211211112', '2' => '112211112', '3' => '212211111', '4' => '111221112', '5' => '211221111', '6' => '112221111', '7' => '111211212', '8' => '211211211', '9' => '112211211', 'A' => '211112112', 'B' => '112112112', 'C' => '212112111', 'D' => '111122112', 'E' => '211122111', 'F' => '112122111', 'G' => '111112212', 'H' => '211112211', 'I' => '112112211', 'J' => '111122211', 'K' => '211111122', 'L' => '112111122', 'M' => '212111121', 'N' => '111121122', 'O' => '211121121', 'P' => '112121121', 'Q' => '111111222', 'R' => '211111221', 'S' => '112111221', 'T' => '111121221', 'U' => '221111112', 'V' => '122111112', 'W' => '222111111', 'X' => '121121112', 'Y' => '221121111', 'Z' => '122121111', '-' => '121111212', '.' => '221111211', ' ' => '122111211', '$' => '121212111', '/' => '121211121', '+' => '121112121', '%' => '111212121', '*' => '121121211'];
        $code = strtoupper($code);
        $checkdigit = '';
        if ($extended) {
            // extended mode
            $code = $this->encode_ext($code);
        }
        if ($code === false) {
            throw new \Mpdf\Barcode\Barcode_Exception(sprintf('Invalid CODE39 barcode value "%s"', $code));
        }
        if ($checksum) {
            // checksum
     ...
     * @return string
     */
    protected function encode_ext($code)
    {
