 ...
 */
class Ean_Ext extends \Mpdf\Barcode\Abstract_Barcode implements \Mpdf\Barcode\Barcode_Interface
{
    /**
     * @param string $code
     * @param int $length
     ...
     */
    public function __construct($code, $length, $left_margin, $right_margin, $x_dim, $bar_height, $separator_margin)
    {
        ...
        $this->data['sepM'] = $separator_margin;
    ...
    private function init($code, $length = 5)
    {
        ...
        if ($length == 2) {
            ...
            throw new \Mpdf\Barcode\Barcode_Exception(sprintf('Invalid EAN barcode value "%s"', $code));
        }
