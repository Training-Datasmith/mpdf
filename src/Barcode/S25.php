 ...
 */
class S25 extends \Mpdf\Barcode\Abstract_Barcode implements \Mpdf\Barcode\Barcode_Interface
{
    /**
     * @param string $code
     * @param bool $checksum
    ...
    {
        $chr = ['0' => '10101110111010', '1' => '11101010101110', '2' => '10111010101110', '3' => '11101110101010', '4' => '10101110101110', '5' => '11101011101010', '6' => '10111011101010', '7' => '10101011101110', '8' => '10101110111010', '9' => '10111010111010'];
        $checkdigit = '';
        if ($checksum) {
            // add checksum
        ...
        for ($i = 0; $i < $clen; ++$i) {
            ...
            if (!isset($chr[$digit])) {
                // invalid character
                throw new \Mpdf\Barcode\Barcode_Exception(sprintf('Invalid character "%s" in S25 barcode value "%s"', $digit, $code));
            }
            $seq .= $chr[$digit];
        }
        $seq .= '1101011';
