...
use Mpdf\Css\Default_Css;
use Mpdf\Language\Language_To_Font;
use Mpdf\Language\Script_To_Language;
use Mpdf\Ucdn;
    ...
    public function __construct()
    {
        $this->defaults = [
            ...
            */
            ...
            'defaultCSS' => Default_Css::$definition,
            'defaultCssFile' => __DIR__ . '/../../data/mpdf.css',
            'customProperties' => [],
            'languageToFont' => new Language_To_Font(),
            'scriptToLanguage' => new Script_To_Language(),
            //////////////////////////////////////////////////
